    ...
    return textTheme
        .copyWith(
          bodyText1: textTheme.bodyText1?.copyWith(
            height: 1.4,
            fontSize: textTheme.bodyText1!.fontSize! * ratio,
            locale: Locale('ja', 'JP'),
          ),
          ...
          headline1:
              textTheme.headline1?.copyWith(fontSize: (textTheme.headline1!.fontSize! * ratio).toInt().toDouble()),
